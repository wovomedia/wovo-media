...
test('validation3 request and mapped workflow cannot become an upload through variable changes', async () => {
  assert.deepEqual(await json('ci/testflight-request.json'), {
    request: 'validation3', version: '1.0', build: '1', operation: 'validate-only',
  });
