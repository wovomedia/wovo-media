    ...
    <div style={{minHeight:'100vh',background:'var(--bg)',position:'relative'}}>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 40px',position:'relative',zIndex:2}}>
        ...
        {[
          ...
          ['Information Sharing', 'We share your information only with trusted service providers necessary to operate our platform: Stripe (payment processing), Supabase (secure database storage), Resend (email delivery), HeyGen (AI video generation), and Anthropic (AI content generation). We do not sell your personal information to third parties. We do not share your information with advertisers.'],
