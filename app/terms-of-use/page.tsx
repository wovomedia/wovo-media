...
const sections = [
  ...
  ["6. Subscription and separate services", "The core workspace renews at the monthly, three-month, or yearly cadence selected and shown in Stripe Checkout. On-site production, drone work, website projects, custom editing, travel, and additional staff time are not included unless separately scoped and purchased."],
