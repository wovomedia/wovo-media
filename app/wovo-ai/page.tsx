...
export default function WovoAiPage() {
  ...
  return (
    <main className="min-h-screen bg-[#060807] text-white">
      {showPlanModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-3 backdrop-blur sm:p-0">
          <div className="relative w-full max-w-full overflow-hidden rounded-2xl border border-white/10 bg-[#0d1110] p-4 text-white shadow-xl sm:max-w-5xl sm:p-6">
            ...
            <div className="grid min-w-0 gap-4 md:grid-cols-3">
              {planOptions.map((plan) => (
                <article key={plan.priceId} className={`min-w-0 rounded-xl border p-4 transition duration-200 md:hover:scale-[1.02] ${plan.name === "Pro" ? "border-emerald-400/80 bg-emerald-500/10" : "border-white/10 bg-black/30"}`}>
