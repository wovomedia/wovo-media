...
export default function BuyCreditsClient() {
  ...
  const canceledMessage = useMemo(() => {
    ...
    return "Checkout canceled. You can try again anytime.";
  }, [canceled]);
  ...
  return (
    <main className="min-h-screen bg-[#060807] text-white">
      <div className="mx-auto w-full max-w-5xl px-6 py-10">
        ...
        {canceledMessage && (
          <div className="mb-6 rounded-xl border border-amber-300/40 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
            {canceledMessage}
          </div>
        )}
